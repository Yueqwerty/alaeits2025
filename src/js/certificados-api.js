...
(function() {
    ...
    class CertificadosAPISystem {
        ...
        showDocumentView() {
            ...
            if (userPaperId) {
                const paperIds = this.currentCertificates.map(c => c.paper_id).join(', ');
                ...
                card.innerHTML = `
                    ...
                    <div class="certificate-meta">
                        <div class="meta-item">
                            ...
                            <span>${this.escapeHtml(cert.eje || 'N/A')}</span>
                        </div>
                        <div class="meta-item">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span>${this.escapeHtml(cert.country || 'N/A')}</span>
                        </div>
                        <div class="meta-item">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="certificate-institution">
                        <strong>Institución:</strong> ${this.escapeHtml(cert.institution || 'N/A')}
                    </div>
